...
import com.example.lab6_kot104.Movie
import com.example.lab6_kot104.MovieItem
import com.example.lab6_kot104.R

class Movie_Screen : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent{
            MovieScreen(movies = com.example.lab6_kot104.Bai2.Movie.getSampleMovies())
        }
    }
}

@Composable
fun MovieScreen(movies: List<com.example.lab6_kot104.Bai2.Movie>) {
...
@Composable
fun MovieRow(movies: List<com.example.lab6_kot104.Bai2.Movie>) {
    LazyRow(
...
@Composable
fun MovieColumn(movies: List<com.example.lab6_kot104.Bai2.Movie>) {
    LazyColumn(
        state = rememberLazyListState(),
        contentPadding = PaddingValues(horizontal = 8.dp, vertical = 16.dp),
...
@Composable
fun MovieGrid(movies: List<com.example.lab6_kot104.Bai2.Movie>) {
...
@Composable
fun MovieItem(movie: com.example.lab6_kot104.Bai2.Movie, listType: ListType) {
    Card(
...
@Composable
fun MovieColumnItem(movie: com.example.lab6_kot104.Bai2.Movie, listType: ListType) {
    Card(
        colors = CardDefaults.cardColors(containerColor =
        Color.White),
        elevation = CardDefaults.cardElevation(defaultElevation =
